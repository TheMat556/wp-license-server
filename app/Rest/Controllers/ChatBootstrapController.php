<?php
/**
 * REST controller for POST /license-server/v1/chat/bootstrap.
 *
...
final class ChatBootstrapController {
    ...
    public function handle( \WP_REST_Request $request ): \WP_REST_Response {
        ...
        $check = $this->feature_gate->require_feature( TierConfig::ROUTE_FEATURES['chat/bootstrap'], $license );
